from src.yolact.backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone
...
coco_defect_dataset = dataset_base.copy({
    'name': 'Woods Defect',
    'train_info': 'D:/Project/VSProject/project_ml_dcnn/data/dataset_coco/images/train/_annotations.coco.json',
    'train_images': 'D:/Project/VSProject/project_ml_dcnn/data/dataset_coco/images/train/images/',
    'valid_info': 'D:/Project/VSProject/project_ml_dcnn/data/dataset_coco/images/valid/_annotations.coco.json',
    'valid_images': 'D:/Project/VSProject/project_ml_dcnn/data/dataset_coco/images/valid/images/',
    'class_names': ('crack', 'knot', 'mud', 'resin', 'snag', 'tear out', 'wane'),
...
yolact_resnet50_defect_config = yolact_resnet50_config.copy({
    'name': 'yolact_plus_resnet50_defect',
    'dataset': coco_defect_dataset,
    'num_classes': len(coco_defect_dataset.class_names) + 1,
    'max_size': 512,
})
